...
console.log(`[BUY DEBUG] type=${activeCategory} index=${currentItem} color=${currentColor}`);
	...
	await rpc.callServer('FactionWardrobe-BuyFreePolitie', data);
};
		...
		return (
			<div className="faction-wardrobe">
				...
				<div className="faction-wardrobe_buttons">
					{onDuty ? (
						<GradientButton color="purple" onClick={this.finishWorkPolitie.bind(this)}>
							OFF DUTY
						</GradientButton>
					) : (
						<GradientButton onClick={this.startWorkPolitie.bind(this)}>
							ON DUTY
						</GradientButton>
					)}
