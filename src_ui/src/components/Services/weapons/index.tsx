...
//					<Ammo prices={prices} showPayment={this.props.showPayment} /> vine sub <Spec weapon={selectedWeapon} /> care e dupa 					<Spec weapon={selectedWeapon} />
	render() {
		...
		return (
			<div className="weapons">
				<div className="weapons_main">
					...
					<PrimaryTitle className="weapons_title">Magazin de arme</PrimaryTitle>
					<List
					...
					<div className="weapons_footer">
						<OutlineButton isClose>Inchide</OutlineButton>
