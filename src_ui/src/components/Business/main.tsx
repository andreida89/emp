		...
		return (
			<div className="business_main">
				...
				<div className="business_info">
					<BusinessInfoItem title="Proprietar">{owner || 'Absent'}</BusinessInfoItem>
					<BusinessInfoItem title="Profit pe zi">
						{prettify.price(income)}
					</BusinessInfoItem>
					<BusinessInfoItem title="Cost pe zi">
						{prettify.price(tax)}
					</BusinessInfoItem>
					<BusinessInfoItem title={isOwner ? 'Vanzare catre stat' : 'Pret'}>
						{prettify.price(price)}
					</BusinessInfoItem>

					{isOwner && (
						<div className="business_info-owned">
							<BusinessInfoItem title="Zile platite">{paid.toString()}</BusinessInfoItem>
							<BusinessInfoItem title="Pana la profit">{`${hour
								.toString()
