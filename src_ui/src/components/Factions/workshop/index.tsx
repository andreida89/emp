...
export default class Workshop extends Component<Props, State> {
	...
	async getProduct() {
		...
		try {
			...
			showNotification( 'success', 'Ati fabricat cu succes obiectul' );
		} catch ( err: any ) {
			...
			<div className="workshop">
				<div className="workshop_container">
					<div className="workshop_header">
						<PrimaryTitle className="workshop_title">Atelier</PrimaryTitle>
				...
				<div className="workshop_footer">
					...
					<GradientButton onClick={this.getProduct.bind( this )}>Crafteaza</GradientButton>
				</div>
			</div>
		);
	}
