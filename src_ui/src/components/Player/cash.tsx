	...
	render() {
		...
		return recipient ? (
			<div className="player-cash">
				<PrimaryTitle className="player-cash_title">Transfer de numerar</PrimaryTitle>
				...
				<div className="player-cash_footer">
					<OutlineButton onClick={this.closeMenu.bind(this)}>Anulare</OutlineButton>
					<GradientButton form="cash">Transfera</GradientButton>
				</div>
			</div>
		) : null;
	}
