...
console.log(`[BUY DEBUG] type=${activeCategory} index=${currentItem} color=${currentColor}`);
	...
	await rpc.callServer('FactionWardrobe-BuyFreePolice', data);
};
		...
		return (
			<div className="faction-wardrobe">
				...
				<div className="faction-wardrobe_buttons">
					{onDuty ? (
						<GradientButton color="purple" onClick={this.finishWorkPolice.bind(this)}>
							OFF DUTY
						</GradientButton>
					) : (
						<GradientButton onClick={this.startWorkPolice.bind(this)}>
							ON DUTY
						</GradientButton>
					)}
