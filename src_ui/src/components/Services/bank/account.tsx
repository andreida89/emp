	...
	render() {
		return (
			<div className="bank_tab">
				...
				>
<Form>
    <Title>Deschidere cont</Title>

    <Field
        type="text"
        name="account"
        placeholder="Numar dorit (optional)"
        label={`Numarul trebuie sa contina 6 cifre, iar costul sau este de ${ this.props.price } RON. Un numar aleatoriu este gratuit`}
    />
