...
const name = 'santamuerte';

const coords = factions.getCoords(name);
//const garage = new Garage(
//	coords.garage,
//	['chiron19', 'benze55', 'cullinan'],
...
//builder.makeBlip(coords.spawn, { name: 'Cartel de Medellin', model: 76, color: 1 });

const santamuerte = builder.build();

export default santamuerte;
