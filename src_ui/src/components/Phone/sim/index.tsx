			...
			<div className="sim">
				...
				{form ? (
					...
					<form className="sim_form">
						<input type="text" value={phoneNumber || 'Absent'} readOnly />

						<Button onClick={this.openForm.bind(this, 'random')}>Aleatoriu</Button>
						<Button onClick={this.openForm.bind(this, 'custom')}>Dorit</Button>
					</form>
				)}
