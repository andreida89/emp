...
class Contact extends Component<Props> {
	async onControlClick( type: string ) {
		...
		try {
			...
			showNotification( 'error', 'Abonatul este indisponibil' );
		}
	}
...
<Navigation
    close={{ title: 'Contacte', onClick: close }}
    action={{ title: 'Editeaza', onClick: showEditor }}
/>
