...
const ToolShop: React.FC<Props> = (props) => {
  ...
  useEffect(() => {
    ...
    rpc.callServer('ToolShop-GetCash').then((cash: any) => {
    ...
    setTimeout(async () => {
      try {
        ...
        for(const item of cart) {
          const response = await rpc.callServer('ToolShop-Buy', [{ name: item.id, amount: item.qty }, paymentMethod]);
    ...
    <div className="magazin-nou-wrapper">
      ...
      <div className="header">
        <div className="header-title-box">
          ...
          <p className="header-subtitle">Unelte & Echipamente</p>
        </div>
      ...
      <div className="footer">
          <div className="location-card">
            ...
            <span className="loc-val">{locationStr} Magazin de unelte</span>
          </div>
      </div>
    </div>
  </div>
