...
class HUD {
	...
	showSatiety(player: PlayerMp, amount: number) {
        ...
        showThirst(player: PlayerMp, amount: number) {
                HUD.callPlayerBrowser(player, 'Player-SetThirst', amount);
        }
	showViata(player: PlayerMp, amount: number) {
		HUD.callPlayerBrowser(player, 'Player-SetViata', amount);
	}
	showArmura(player: PlayerMp, amount: number) {
		HUD.callPlayerBrowser(player, 'Player-SetArmura', amount);
	}	
