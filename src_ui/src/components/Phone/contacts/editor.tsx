...
<Navigation
    close={{ title: 'Anuleaza', onClick: close }}
    action={{ title: 'Gata', form: 'contact-editor' }}
/>
			...
			>
				<Form id="contact-editor">
					<Group>
						<Field type="text" name="firstName" placeholder="Prenume" component={Input} />
						<Field type="text" name="lastName" placeholder="Nume" component={Input} />
						<Field
							type="text"
							name="phone"
