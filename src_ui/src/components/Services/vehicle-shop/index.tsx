...
class VehicleShop extends Component<Props, State> {
	...
	async buy() {
		...
		try {
			...
			showNotification(
				'success',
				'Ati achizitionat cu succes vehiculul, il puteti livra prin aplicatia de pe telefon'
			);
		} catch ( err: any ) {
	...
	render() {
		...
		return (
			<div className="vehicle-shop">
				...
				Apasati pentru a inchide meniul
				</Hint>
				...
				<div className="vehicle-shop_main">
					...
					<div className="vehicle-shop_buttons">
						...
						<GradientButton onClick={this.buy.bind( this )}>Plateste</GradientButton>
					</div>
				</div>
			</div>
		);
