		...
		return (
			<div className="trading trading--business">
				<div className="trading_top">
					...
					{`${seller ? 'Cumparare' : 'Vanzare'} afacere`}
					</PrimaryTitle>
					...
					<div className="trading_info">
						<div className="trading_info-items">
							...
							Pret de stat: <b>{prettify.price(govPrice)}</b>
							</p>
							<p className="trading_info-item">
								Castig: <b>{prettify.price(income)}</b>
							</p>
						</div>
					</div>
				</div>
				...
				<div className="trading_footer">
					<OutlineButton onClick={this.refuse}>Refuza</OutlineButton>

					{seller ? (
						<GradientButton onClick={this.buy}>Cumpara</GradientButton>
					) : (
						<GradientButton onClick={this.sell.bind(this)}>Ofera</GradientButton>
					)}
				</div>
			</div>
		);
